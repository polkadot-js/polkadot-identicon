	...
	render() {
		...
		if (false) {
			...
			return React.createElement(
				'svg',
				{ width: s, height: s },
				React.createElement('circle', { cx: s / 2, cy: s / 2, r: s / 2, fill: '#fff' }),
				React.createElement('circle', { cx: c, cy: c, r: z, fill: 'red' }),
				React.createElement('circle', { cx: c - r, cy: c, r: z, fill: 'red' }),
				React.createElement('circle', { cx: c - ro2, cy: c - rroot3o2, r: z, fill: 'red' }),
				React.createElement('circle', { cx: c + ro2, cy: c - rroot3o2, r: z, fill: 'red' }),
				React.createElement('circle', { cx: c + r, cy: c, r: z, fill: 'red' }),
				React.createElement('circle', { cx: c + ro2, cy: c + rroot3o2, r: z, fill: 'red' }),
				React.createElement('circle', { cx: c - ro2, cy: c + rroot3o2, r: z, fill: 'red' })
			...
			if (!this.state.id) {
				return React.createElement('svg', { width: s, height: s });
			}
